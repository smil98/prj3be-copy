...
public class SecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/member/add","/member/check/**","/api/board/list","api/board/**", "api/board/file/id/**","api/like/board/**", "/member/orders/**","/api/like/list/**", "/likes/**", "/authenticate","/actuator/**", "api/comment/list").permitAll()
